...
public class CadastroProdutos extends JFrame {
	...
	public void preencheCampos(ModeloProduto produto, JComboBox<String> comboProduto, JComboBox<String> comboEnquadramento) {

		String concatenado = (String) comboProduto.getSelectedItem();
		String desconcatenado = concatenado.substring(1, 5);
		produto.setCodigo(desconcatenado);
		regras.consultaProduto(produto);
	...
	public void limpaCampos(JComboBox<String> comboProduto, JComboBox<String> comboEnquadramento) {
		...
		regras.preencheCombo(comboProduto);
	...
	public CadastroProdutos() {
		...
		comboProduto.addPopupMenuListener(new PopupMenuListener() {
			...
			public void popupMenuWillBecomeInvisible(PopupMenuEvent arg0) {
				if ((String) comboProduto.getSelectedItem() == "<NOVO PRODUTO>") {
					...
					preencheCampos(produto, comboProduto, comboEnquadramento);
				}
			}
				...
				gl_contentPane
						...
						.addGroup(
								gl_contentPane
										...
										.addGroup(
												gl_contentPane.createSequentialGroup().addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addComponent(textCodigo, GroupLayout.PREFERRED_SIZE, 60, GroupLayout.PREFERRED_SIZE).addComponent(lblCodigo)).addGap(18)
														.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane.createSequentialGroup().addComponent(lblNome).addGap(145)).addComponent(textNome, GroupLayout.DEFAULT_SIZE, 178, Short.MAX_VALUE)))
										.addGroup(
												gl_contentPane.createSequentialGroup().addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING, false).addComponent(lblEnquadramento).addComponent(comboEnquadramento, GroupLayout.PREFERRED_SIZE, 152, GroupLayout.PREFERRED_SIZE)).addGap(18)
														.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addComponent(textValor).addComponent(lblValor)))
										.addGroup(
												gl_contentPane.createSequentialGroup().addComponent(btnCadastrar, GroupLayout.PREFERRED_SIZE, 85, GroupLayout.PREFERRED_SIZE).addPreferredGap(ComponentPlacement.RELATED)
														.addComponent(btnAlterar, GroupLayout.PREFERRED_SIZE, 80, GroupLayout.PREFERRED_SIZE).addPreferredGap(ComponentPlacement.UNRELATED).addComponent(btnExcluir, GroupLayout.PREFERRED_SIZE, 80, GroupLayout.PREFERRED_SIZE)).addComponent(lblProduto)
										.addComponent(comboProduto, 0, 256, Short.MAX_VALUE)).addContainerGap()));
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(
				gl_contentPane
						...
						.addPreferredGap(ComponentPlacement.RELATED)
						.addGroup(
								gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(textCodigo, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE).addComponent(textNome, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(ComponentPlacement.RELATED)
						.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(lblEnquadramento).addComponent(lblValor))
						.addPreferredGap(ComponentPlacement.RELATED)
						.addGroup(
								gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(comboEnquadramento, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
										.addComponent(textValor, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
						.addGap(10)
						.addGroup(
								gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(btnCadastrar, GroupLayout.PREFERRED_SIZE, 25, GroupLayout.PREFERRED_SIZE).addComponent(btnExcluir, GroupLayout.PREFERRED_SIZE, 25, GroupLayout.PREFERRED_SIZE)
